 ...
 * {@includeCode ./mcp-agent.test.ts#example-mcp-agent-from-sse}
 */
export class MCPAgent extends Agent {
   ...
   * {@includeCode ./mcp-agent.test.ts#example-mcp-agent-from-streamable-http}
   *
   * @example
   * Here's an example of creating an MCPAgent with SSE transport:
   * {@includeCode ./mcp-agent.test.ts#example-mcp-agent-from-sse}
   ...
   * {@includeCode ./mcp-agent.test.ts#example-mcp-agent-from-stdio}
   */
   ...
   * {@includeCode ./mcp-agent.test.ts#example-mcp-agent-direct}
   */
   ...
   * {@includeCode ./mcp-agent.test.ts#example-mcp-agent-prompts}
   */
   ...
   * {@includeCode ./mcp-agent.test.ts#example-mcp-agent-resources}
   */
   ...
   * {@includeCode ./mcp-agent.test.ts#example-mcp-agent-shutdown}
   *
   * @example
   * Here's an example of shutting down an MCPAgent by using statement:
   * {@includeCode ./mcp-agent.test.ts#example-mcp-agent-shutdown-by-using}
   */
